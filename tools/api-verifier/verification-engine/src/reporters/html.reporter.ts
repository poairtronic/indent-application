...
export function generateHtmlReport(report: VerificationReport, outputPath: string): void {
...
`;
  ...
  for (const row of report.matrix) {
    ...
    if (row.result === 'MISMATCH') { trClass = 'mismatch'; badgeClass = 'badge-mismatch'; }
    else if (row.result !== 'MATCH') { trClass = 'missing'; badgeClass = 'badge-missing'; }
