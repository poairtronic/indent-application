...
async function run() {
  ...
  console.log(`Hitting GET http://localhost:5175/api/business-transactions/${btId} with token...`);
  
  try {
    const btResponse = await axios.get(`http://localhost:5175/api/business-transactions/${btId}`, {
