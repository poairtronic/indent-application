...
async function run() {
  ...
  for (let i = 0; i < ITERATIONS; i++) {
    ...
    const createRes = await safeFetch(`${BASE_URL}/business-transactions`, {
    ...
    if (!indentId) throw new Error('No indentId returned');

    // Submit
    t0 = performance.now();
    console.log('submitDesign');
    await safeFetch(`${BASE_URL}/business-transactions/${indentId}/submit`, {
    ...
    // Stores Verify
    t0 = performance.now();
    console.log('storesVerify');
    await safeFetch(`${BASE_URL}/business-transactions/${indentId}/stores/verify`, {
      method: 'POST', headers: authHeaders, body: JSON.stringify({ remarks: 'Bench' }),
    });
    ...
    // Stores Issue (bulk)
    t0 = performance.now();
    console.log('storesIssue');
    await safeFetch(`${BASE_URL}/business-transactions/${indentId}/stores/issue`, {
      method: 'POST', headers: authHeaders, body: JSON.stringify({ remarks: 'Bench' }),
    });
    ...
    // Production Receive
    t0 = performance.now();
    console.log('productionReceive');
    await safeFetch(`${BASE_URL}/business-transactions/${indentId}/production/receive`, {
      method: 'POST', headers: authHeaders, body: JSON.stringify({ remarks: 'Bench' }),
    });
    ...
    // Production Complete
    t0 = performance.now();
    console.log('productionComplete');
    await safeFetch(`${BASE_URL}/business-transactions/${indentId}/production/complete`, {
      method: 'POST', headers: authHeaders, body: JSON.stringify({ remarks: 'Bench' }),
    });
    ...
    // Accounts Verify
    t0 = performance.now();
    console.log('accountsVerify');
    await safeFetch(`${BASE_URL}/business-transactions/${indentId}/accounts/verify`, {
      method: 'POST', headers: authHeaders, body: JSON.stringify({ remarks: 'Bench' }),
    });
    ...
    console.log('getTx');
    const getRes = await safeFetch(`${BASE_URL}/business-transactions/${indentId}`, { headers: authHeaders });
    ...
    await safeFetch(`${BASE_URL}/business-transactions/${indentId}/accounts/actual-cost`, {
    ...
    // Financial Closure
    t0 = performance.now();
    console.log('financialClosure');
    await safeFetch(`${BASE_URL}/business-transactions/${indentId}/accounts/financial-close`, {
    ...
    t0 = performance.now();
    console.log('archive');
    await safeFetch(`${BASE_URL}/business-transactions/${indentId}/archive`, {
      method: 'POST', headers: authHeaders, body: JSON.stringify({ remarks: 'Bench' }),
    });
