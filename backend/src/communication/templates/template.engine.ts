...
const INLINE_TEMPLATES: Record<string, string> = {
  ...
  actual_cost_updated: `<h2>Actual Cost Updated</h2><p>Actual costs updated for Indent #{{indentNumber}}.</p>`,
  transaction_archived: `<h2>Transaction Archived</h2><p>Indent #{{indentNumber}} archived.</p>`,
  transaction_completed: `<h2>Transaction Completed</h2><p>Indent #{{indentNumber}} completed.</p>`,
