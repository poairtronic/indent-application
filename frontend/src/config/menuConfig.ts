...
export const menuItems: MenuItem[] = [
  { label: 'Dashboard', path: '/dashboard', iconName: 'LayoutDashboard', permission: 'analytics.view' },
  ...
  { label: 'Processes', path: '/manufacturing-processes', iconName: 'Wrench', permission: 'manufacturing-processes.view' },
