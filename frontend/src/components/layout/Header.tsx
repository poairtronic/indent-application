    ...
    <>
      <header className="h-16 border-b border-border-default topbar-glass px-6 flex items-center justify-between font-sans transition-colors duration-300 sticky top-0 z-40">
        ...
        <div className="flex items-center space-x-3">
          {/* Environment Badge */}
          <span className="text-[9px] font-extrabold px-1.5 py-0.5 bg-accent-primary/10 text-accent-primary rounded border border-accent-primary/20 uppercase tracking-wider">
            {environment}
          </span>
              ...
              <>
                ...
                <div className="absolute right-0 mt-2 w-48 bg-surface-card border border-border-default rounded-xl shadow-dropdown py-1 z-20 font-sans">
                  ...
                  <Link
                    ...
                    className="block px-4 py-2 text-xs text-text-secondary hover:bg-background-secondary hover:text-text-primary transition-colors"
                  >
                    My Profile
                  </Link>
                  <Link
                  ...
                  <button
                    ...
                    className="w-full text-left px-4 py-2 text-xs text-status-error hover:bg-background-secondary transition-colors focus:outline-none"
                  >
                    Logout Session
                  </button>
                </div>
