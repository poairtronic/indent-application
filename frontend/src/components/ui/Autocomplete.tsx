  ...
  return (
    <div ref={containerRef} className={`w-full font-sans text-xs relative ${className}`}>
      ...
      <div className="relative">
        <input
          type="text"
          className={`w-full bg-background-primary border rounded-lg pl-8 pr-16 py-2 text-xs text-text-primary outline-none transition-all focus:ring-1 focus:ring-accent-primary focus:border-accent-primary disabled:opacity-50 disabled:cursor-not-allowed ${
