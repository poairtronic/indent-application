        ...
        <div>
          ...
          <div className="relative">
            ...
            <button
              ...
              className="absolute inset-y-0 right-0 pr-3.5 flex items-center text-[#94A3B8] hover:text-[#6D4AFF] dark:text-gray-400 dark:hover:text-white transition-colors focus:outline-none"
